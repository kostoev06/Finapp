...
import com.example.finapp.ui.feature.tags.viewmodel.TagsViewModel
...
import com.example.finapp.ui.feature.tags.viewmodel.TagsViewModelFactory
...
fun TagsContent(
    ...
    Scaffold(
        topBar = {
            HomeTopBar(
                title = { Text(stringResource(R.string.tags_top_title)) }
            )
        },
        modifier = modifier
    ) { innerPadding ->
