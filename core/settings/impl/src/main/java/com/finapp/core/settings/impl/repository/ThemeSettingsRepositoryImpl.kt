...
import com.finapp.core.settings.impl.di.UiSettingsDataStore
...
class ThemeSettingsRepositoryImpl @Inject constructor(
    ...
    override suspend fun setThemeMode(mode: ThemeMode) {
        dataStore.edit { it[DataStoreKeys.THEME_MODE] = mode.name }
    }

    override suspend fun setBrandColor(color: BrandColorOption) {
        dataStore.edit { it[DataStoreKeys.BRAND_COLOR] = color.name }
    }
}
